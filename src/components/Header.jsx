      ...
      <header className="govuk-header" role="banner" data-module="header">
        <div className="govuk-header__container govuk-width-container">
          <div className="govuk-header__logo">
            <Link className="govuk-header__link govuk-header__link--homepage" to="/">
              <span className="govuk-header__logotype">
                <svg className="govuk-header__logotype-crown" role="presentation" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 132 97" height="32" width="36">
                  ...
                  <image className="govuk-header__logotype-crown-fallback-image" src="/assets/images/govuk-logotype-crown.png"></image> 
                </svg> <span className="govuk-header__logotype-text">GOV.UK</span>
              </span>
            </Link>
          </div>
